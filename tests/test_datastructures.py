...
def test_headers():
	...
	assert headers.get("header_0") == None
	...
	assert headers.items() == [("header_1", "valur_header_1"), ("header_2", "valur_header_2")]
...
def test_query_params():
	...
	assert params.get("param_0") == None
	...
	assert params.items() == [("param_1", "valur_param_1"), ("param_2", "valur_param_2")]
	assert len(params) == 2
